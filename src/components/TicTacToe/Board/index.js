...
const Board = ({ tiles, onTileClick, playerTurn, strikeClass }) => {
  return (
    <div className='board'>
      <Tile playerTurn={playerTurn} onClick={() => onTileClick(0)} value={tiles[0]} className='bottom-border right-border' />
      <Tile playerTurn={playerTurn} onClick={() => onTileClick(1)} value={tiles[1]} className='bottom-border right-border' />
      <Tile playerTurn={playerTurn} onClick={() => onTileClick(2)} value={tiles[2]} className='bottom-border'/>
      <Tile playerTurn={playerTurn} onClick={() => onTileClick(3)} value={tiles[3]} className='bottom-border right-border' />
